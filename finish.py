...
class Screen(object):
    ...
    def triangle(coords, texture):
        ...
        def deltas(i, j, divider): return [float(i.z - j.z) / divider, float(i.u - j.u) / divider,
        ...
        for p in (b, c):
            ...
            while p1.y < p.y:
                ...
                delta_z3, delta_u3, delta_v3 = deltas(
                    p4, p3, (p4.x - p3.x) or 1)
                while p3.x < p4.x:
...
# Функуия отрисовки лица


def show_face() -> object:
